import React, { useEffect, useState } from "react";import { useForm } from "../../../hooks/UseForm";
...
export default function Session() {
    ...
    const castToSecond=(time)=> time.split(":").reverse().reduce((total,time,index)=>total+time*(60**index),0)
    ...
    const createSession = (event) => {
      ...
      formData.append("time",castToSecond(formState.inputs.time.value))
